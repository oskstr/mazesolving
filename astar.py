        ...
        for v in u.neighbours:
            if v != None:
                ...
                if visited[vposindex] == False:
                    ...
                    # Some descriptions of A* call this the g cost.
                    # New distance is the distance of the path from
                    # the start, through U, to V.
                    newdistance = distances[uposindex] + d

                    # A* includes a remaining cost, the f cost.
                    # In this case we use manhattan distance to
                    # calculate the distance from V to the end.
                    # We use manhattan again because A* works
                    # well when the g cost and f cost are balanced.
			...
			# priority than some other nodes. The order we visit
                        # nodes is a trade-off between a short path, and moving
			# closer to the goal.
